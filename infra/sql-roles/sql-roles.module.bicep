...
resource script_sql_sqldata 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('sql', principalName, 'sqldata', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
